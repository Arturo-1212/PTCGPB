...
global winTitle, changeDate, failSafe, openPack, Delay, failSafeTime, StartSkipTime, Columns, failSafe, adbPort, scriptName, adbShell, adbPath, GPTest, StatusText, defaultLanguage, setSpeed, jsonFileName, pauseToggle, SelectedMonitorIndex, swipeSpeed, godPack, scaleParam, discordUserId, discordWebhookURL, skipInvalidGP, deleteXML, packs, FriendID, AddFriend, Instances, showStatus
	...
	IniRead, FriendID, %A_ScriptDir%\..\settings2.ini, UserSettings, FriendID
	IniRead, Instances, %A_ScriptDir%\..\settings2.ini, UserSettings, Instances
	IniRead, Delay, %A_ScriptDir%\..\settings2.ini, UserSettings, Delay, 250
	IniRead, folderPath, %A_ScriptDir%\..\settings2.ini, UserSettings, folderPath, C:\Program Files\Netease
	IniRead, Variation, %A_ScriptDir%\..\settings2.ini, UserSettings, Variation, 20
	IniRead, changeDate, %A_ScriptDir%\..\settings2.ini, UserSettings, ChangeDate, 0100
	IniRead, Columns, %A_ScriptDir%\..\settings2.ini, UserSettings, Columns, 5
	IniRead, openPack, %A_ScriptDir%\..\settings2.ini, UserSettings, openPack, 1
	IniRead, setSpeed, %A_ScriptDir%\..\settings2.ini, UserSettings, setSpeed, 2x
	IniRead, defaultLanguage, %A_ScriptDir%\..\settings2.ini, UserSettings, defaultLanguage, Scale125
	IniRead, SelectedMonitorIndex, %A_ScriptDir%\..\settings2.ini, UserSettings, SelectedMonitorIndex, 1:
	IniRead, swipeSpeed, %A_ScriptDir%\..\settings2.ini, UserSettings, swipeSpeed, 600
	IniRead, skipInvalidGP, %A_ScriptDir%\..\settings2.ini, UserSettings, skipInvalidGP, No
	IniRead, godPack, %A_ScriptDir%\..\settings2.ini, UserSettings, godPack, Continue
	IniRead, discordWebhookURL, %A_ScriptDir%\..\settings2.ini, UserSettings, discordWebhookURL, ""
	IniRead, discordUserId, %A_ScriptDir%\..\settings2.ini, UserSettings, discordUserId, ""
	IniRead, deleteMethod, %A_ScriptDir%\..\settings2.ini, UserSettings, deleteMethod, Hoard
	IniRead, sendXML, %A_ScriptDir%\..\settings2.ini, UserSettings, sendXML, 0
	IniRead, heartBeat, %A_ScriptDir%\..\settings2.ini, UserSettings, heartBeat, 1
	if(heartBeat)
